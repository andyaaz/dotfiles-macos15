...
export PATH=$PATH:/usr/local/bin:/opt/X11/bin:/Library/Frameworks/Mono.framework/Versions/Current/Commands:$HOME/.rvm/bin
...
# set alias for ipython
alias ipython='python3 -m IPython'

# config vim to show correct color in tmux
alias tmux="TERM=screen-256color-bce tmux"

# add ctags to $PATH
alias ctags="`brew --prefix`/bin/ctags"

# add manjaro ssh alias
alias manjaro="ssh -p 19020 andyan@manjaro.andyan.dev"

# autoload -U promptinit; promptinit
# Set Spaceship ZSH as a prompt
# prompt spaceship

# Set Pure as ZSH prompt theme
# prompt pure
